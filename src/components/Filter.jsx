...
function Filter({ setFilteredItems, filteredItems }) {
	return (
		<div className="bg-white shadow-md shadow-primary -mt-12 lg:-mt-10 rounded-md flex p-6 static lg:absolute top-0 left-0 right-0 lg:mx-8">
			<ul className="flex w-[85%] gap-4 flex-wrap">
				{filteredItems.map((item) => {
					return (
						<li
							className="bg-lightGreyishCyanFT flex rounded-md overflow-hidden text-primary font-bold text-lg"
							key={item}
						>
			...
			<div className="w-[15%] flex items-center justify-end font-bold text-darkGreyishCyan ">
				<a
